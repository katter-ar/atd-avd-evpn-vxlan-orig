...
| --------- | --------------- | ------------ | --------- |
| LeafPair2 | Vlan4094 | 192.0.0.234 | Port-Channel1000 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_s2-leaf3_Ethernet1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1000 |
| Ethernet6 | MLAG_PEER_s2-leaf3_Ethernet6 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1000 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_LINK_TO_S2-SPINE1_Ethernet5 | routed | - | 10.255.1.221/31 | default | 9214 | False | - | - |
| Ethernet3 | P2P_LINK_TO_S2-SPINE2_Ethernet5 | routed | - | 10.255.1.223/31 | default | 9214 | False | - | - |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1000 | MLAG_PEER_s2-leaf3_Po1000 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.1.0.120/32 |
...
| Vlan4001 |  A  |  192.2.2.235/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  192.1.1.235/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  192.0.0.235/31  |  -  |  -  |  -  |  -  |  -  |
...
interface Vlan4001
   ...
   mtu 9214
   vrf A
   ip address 192.2.2.235/31
!
interface Vlan4093
   description MLAG_PEER_L3_PEERING
   no shutdown
   mtu 9214
   ip address 192.1.1.235/31
!
interface Vlan4094
...
| 10.255.1.220 | 65100 | default | - | Inherited from peer group IPV4-UNDERLAY-PEERS | Inherited from peer group IPV4-UNDERLAY-PEERS | - | - | - | - |
| 10.255.1.222 | 65100 | default | - | Inherited from peer group IPV4-UNDERLAY-PEERS | Inherited from peer group IPV4-UNDERLAY-PEERS | - | - | - | - |
| 192.1.1.234 | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | - | - | - | - |
| 192.2.2.234 | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | A | - | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 10.1.0.120:10010 | 10010:10010 | - | - | learned |
| 20 | 10.1.0.120:10020 | 10020:10020 | - | - | learned |
| 112 | 10.1.0.120:10112 | 10112:10112 | - | - | learned |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| A | 10.1.0.120:50001 | connected |
...
router bgp 65102
   ...
   neighbor 10.255.1.220 peer group IPV4-UNDERLAY-PEERS
   neighbor 10.255.1.220 remote-as 65100
   neighbor 10.255.1.220 description s2-spine1_Ethernet5
   neighbor 10.255.1.222 peer group IPV4-UNDERLAY-PEERS
   neighbor 10.255.1.222 remote-as 65100
   neighbor 10.255.1.222 description s2-spine2_Ethernet5
   neighbor 192.1.1.234 peer group MLAG-IPV4-UNDERLAY-PEER
   neighbor 192.1.1.234 description s2-leaf3
   ...
   vrf A
      ...
      router-id 10.1.0.120
      neighbor 192.2.2.234 peer group MLAG-IPV4-UNDERLAY-PEER
