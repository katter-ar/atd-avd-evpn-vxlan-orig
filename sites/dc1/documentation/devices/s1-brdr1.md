...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_s1-brdr2_Ethernet1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1000 |
| Ethernet6 | MLAG_PEER_s1-brdr2_Ethernet6 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1000 |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1000 | MLAG_PEER_s1-brdr2_Po1000 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel1000
   description MLAG_PEER_s1-brdr2_Po1000
   no shutdown
   switchport
...
| 112 | 10.1.0.2:10112 | 10112:10112<br>remote 10112:10112 | - | - | learned |
...
router bgp 65099
   ...
   neighbor 192.1.1.3 description s1-brdr2
   ...
   vlan 112
      rd 10.1.0.2:10112
      rd evpn domain remote 10.1.0.2:10112
