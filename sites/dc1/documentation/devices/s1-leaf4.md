...
| --------- | --------------- | ------------ | --------- |
| LeafPair2 | Vlan4094 | 192.0.0.34 | Port-Channel1000 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_s1-leaf3_Ethernet1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1000 |
| Ethernet6 | MLAG_PEER_s1-leaf3_Ethernet6 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1000 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_LINK_TO_S1-SPINE1_Ethernet5 | routed | - | 10.255.0.77/31 | default | 9214 | False | - | - |
| Ethernet3 | P2P_LINK_TO_S1-SPINE2_Ethernet5 | routed | - | 10.255.0.79/31 | default | 9214 | False | - | - |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1000 | MLAG_PEER_s1-leaf3_Po1000 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.1.0.20/32 |
...
| Vlan4001 |  A  |  192.2.2.35/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  192.1.1.35/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  192.0.0.35/31  |  -  |  -  |  -  |  -  |  -  |
...
interface Vlan4001
   ...
   mtu 9214
   vrf A
   ip address 192.2.2.35/31
!
interface Vlan4093
   description MLAG_PEER_L3_PEERING
   no shutdown
   mtu 9214
   ip address 192.1.1.35/31
!
interface Vlan4094
...
| 10.255.0.76 | 65000 | default | - | Inherited from peer group IPV4-UNDERLAY-PEERS | Inherited from peer group IPV4-UNDERLAY-PEERS | - | - | - | - |
| 10.255.0.78 | 65000 | default | - | Inherited from peer group IPV4-UNDERLAY-PEERS | Inherited from peer group IPV4-UNDERLAY-PEERS | - | - | - | - |
| 192.1.1.34 | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | - | - | - | - |
| 192.2.2.34 | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | A | - | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 10.1.0.20:10010 | 10010:10010 | - | - | learned |
| 20 | 10.1.0.20:10020 | 10020:10020 | - | - | learned |
| 112 | 10.1.0.20:10112 | 10112:10112 | - | - | learned |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| A | 10.1.0.20:50001 | connected |
...
router bgp 65002
   ...
   neighbor 10.255.0.76 remote-as 65000
   neighbor 10.255.0.76 description s1-spine1_Ethernet5
   neighbor 10.255.0.78 peer group IPV4-UNDERLAY-PEERS
   neighbor 10.255.0.78 remote-as 65000
   neighbor 10.255.0.78 description s1-spine2_Ethernet5
   neighbor 192.1.1.34 peer group MLAG-IPV4-UNDERLAY-PEER
   neighbor 192.1.1.34 description s1-leaf3
   ...
   vrf A
      ...
      router-id 10.1.0.20
      neighbor 192.2.2.34 peer group MLAG-IPV4-UNDERLAY-PEER
