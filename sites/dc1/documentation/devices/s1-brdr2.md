...
| --------- | --------------- | ------------ | --------- |
| BrdrLeafs | Vlan4094 | 192.0.0.2 | Port-Channel1000 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_s1-brdr1_Ethernet1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1000 |
| Ethernet6 | MLAG_PEER_s1-brdr1_Ethernet6 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1000 |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1000 | MLAG_PEER_s1-brdr1_Po1000 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Vlan4001
   ...
   mtu 9214
   vrf A
   ip address 192.2.2.3/31
!
interface Vlan4093
   description MLAG_PEER_L3_PEERING
   no shutdown
   mtu 9214
   ip address 192.1.1.3/31
!
interface Vlan4094
...
| 172.16.255.5 | 65501 | default | - | Inherited from peer group IPV4-UNDERLAY-PEERS | Inherited from peer group IPV4-UNDERLAY-PEERS | - | - | - | - |
| 172.16.255.7 | 65501 | default | - | Inherited from peer group IPV4-UNDERLAY-PEERS | Inherited from peer group IPV4-UNDERLAY-PEERS | - | - | - | - |
| 192.1.1.2 | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | - | - | - | - |
| 192.2.2.2 | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | A | - | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | - | - | - | - |
...
| EVPN-OVERLAY-REMOTE-PEERS | True |
...
router bgp 65099
   ...
   neighbor 172.16.255.5 remote-as 65501
   neighbor 172.16.255.5 description s1-core1 VRF Default
   neighbor 172.16.255.7 peer group IPV4-UNDERLAY-PEERS
   neighbor 172.16.255.7 remote-as 65501
   neighbor 172.16.255.7 description s1-core2 VRF Default
   neighbor 192.1.1.2 peer group MLAG-IPV4-UNDERLAY-PEER
   neighbor 192.1.1.2 description s1-brdr1
   ...
   vrf A
      ...
      router-id 10.1.0.4
      neighbor 192.2.2.2 peer group MLAG-IPV4-UNDERLAY-PEER
