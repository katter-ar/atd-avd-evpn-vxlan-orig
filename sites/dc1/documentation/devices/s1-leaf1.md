...
| --------- | --------------- | ------------ | --------- |
| LeafPair1 | Vlan4094 | 192.0.0.27 | Port-Channel1000 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_s1-leaf2_Ethernet1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1000 |
| Ethernet4 | HOSTA_Eth1 | *access | *112 | *- | *- | 4 |
| Ethernet6 | MLAG_PEER_s1-leaf2_Ethernet6 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1000 |
...
| Port-Channel1000 | MLAG_PEER_s1-leaf2_Po1000 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel1000
   description MLAG_PEER_s1-leaf2_Po1000
   no shutdown
   switchport
...
| Vlan4001 |  A  |  192.2.2.26/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  192.1.1.26/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  192.0.0.26/31  |  -  |  -  |  -  |  -  |  -  |
...
interface Vlan4001
   ...
   mtu 9214
   vrf A
   ip address 192.2.2.26/31
!
interface Vlan4093
   description MLAG_PEER_L3_PEERING
   no shutdown
   mtu 9214
   ip address 192.1.1.26/31
!
interface Vlan4094
...
| 192.1.1.27 | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | - | - | - | - |
| 192.2.2.27 | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | A | - | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | - | - | - | - |
...
| 112 | 10.1.0.14:10112 | 10112:10112 | - | - | learned |
...
router bgp 65001
   ...
   neighbor 192.1.1.27 peer group MLAG-IPV4-UNDERLAY-PEER
   neighbor 192.1.1.27 description s1-leaf2
   ...
   vrf A
      ...
      router-id 10.1.0.14
      neighbor 192.2.2.27 peer group MLAG-IPV4-UNDERLAY-PEER
